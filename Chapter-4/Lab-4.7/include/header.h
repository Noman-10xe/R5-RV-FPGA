...
#define SLOW 400		 /* Define a Standard Slow Time, We won't be considering reaction times larger than this*/
...
void delay(int num);
void startGame();
unsigned int lightLEDs(int start);
void compare(unsigned int pattern, int n);
